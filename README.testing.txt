...
mvn clean install -DTARGET_PLATFORM=kepler -DBUILD_TYPE=integration -DIS_TP_VERSION=4.1.8.Final -DVERSION=4.1.4.Final -DBUILD_NUMBER=111 -DBUILD_ALIAS=CI-2013-08-21_20-10-23-B111 -DCOMPOSITE_SITE=file://`pwd`/site/target/repository       -DUPSTREAM_DIRECTORY_XML=http://download.jboss.org/jbosstools/updates/development/kepler/jbosstools-directory.xml       -DCOMPOSITE_URLS=http://download.jboss.org/jbosstools/updates/development/kepler/,http://download.jboss.org/jbosstools/updates/stable/kepler/integration-stack/aggregate/4.1.4.Final/,http://download.jboss.org/jbosstools/targetplatforms/jbtistarget/4.1.8.Final/REPO/

2. Fix generated directory.xml to point to locally-built jar, eg., use this

{code}
<entry url="org.jboss.tools.central.discovery.integration-stack_4.1.4.Final.CI-2013-08-21_20-10-23-B111-v20130101-0001-B111.jar" permitCategories="true"/>
{code}

instead of 

{code}
<entry url="http://download.jboss.org/jbosstools/discovery/stable/integration-stack/4.1.4.Final/org.jboss.tools.central.discovery.integration-stack_4.1.4.Final.CI-2013-08-21_20-10-23-B111-v20130101-0001-B111.jar" permitCategories="true"/>
{code}
