...
{code}
<entry url="org.jboss.tools.central.discovery.integration-stack_4.1.3.CR2.CI-2013-08-21_20-10-23-B111-v20130101-0001-B111.jar" permitCategories="true"/>
{code}

instead of 

{code}
<entry url="http://download.jboss.org/jbosstools/discovery/integration/integration-stack/4.1.3.CR2/org.jboss.tools.central.discovery.integration-stack_4.1.3.CR2.CI-2013-08-21_20-10-23-B111-v20130101-0001-B111.jar" permitCategories="true"/>
{code}
