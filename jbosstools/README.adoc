## Sample invocation to build JBTIS
   ...
   - or -
    ...
    mvn -DUPSTREAM_UPDATE_SITE=http://download.jboss.org/jbosstools/updates/stable/luna/ -DTARGET_PLATFORM=luna -DIS_TP_VERSION=4.2.2.Final \
        ...
        -DCOMPOSITE_TP_EA_SITE=http://download.jboss.org/jbosstools/targetplatforms/jbtistarget/4.2.2.Final/jbtis/earlyaccess/REPO \
        -DBUILD_ALIAS=${BUILD_ID}-B${BUILD_NUMBER} -DBUILD_TYPE=development \
        -DUPDATE_SITE=http://download.jboss.org/jbosstools/updates/${BUILD_TYPE}/luna/integration-stack/aggregate/4.2.1.Final \
        ...
        -DCOMPOSITE_URLS=http://download.jboss.org/jbosstools/updates/stable/luna/,\
                         ...
                         http://download.jboss.org/jbosstools/targetplatforms/jbtistarget/4.2.2.Final/jbtis/REPO,http://download.jboss.org/jbosstools/targetplatforms/jbtistarget/4.2.2.Final/jbtis/earlyaccess/REPO
