## Sample invocation to build JBT IS
    ...
    -DCOMPOSITE_URLS=,http://download.jboss.org/jbosstools/updates/development/luna/,,http://download.jboss.org/jbosstools/updates/development/luna/integration-stack/aggregate/4.2.1.CR1,http://download.jboss.org/jbosstools/targetplatforms/jbtistarget/4.2.1.Final/REPO/ \
    -DIS_TP_VERSION=4.2.1.Final \
    -DTARGET_PLATFORM=luna \
    -DUPDATE_SITE=http://download.jboss.org/jbosstools/updates/development/luna/integration-stack/aggregate/4.2.1.CR1 \
